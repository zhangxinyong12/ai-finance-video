...
- 抓取海外财经新闻并去重排序。
- 生成面向中国股票受众的海外财经资讯解读脚本，不做个股推荐。
- 优先解释美联储、美元人民币、港股中概、AI 芯片、出口链、通胀和流动性对 A 股情绪的观察意义。
- 黄金、原油和期货新闻只作为宏观变量或成本变量处理，不生成交易策略、点位预测或做多做空建议。
- 生成发布标题、简介、标签、封面文案、分镜口播和画面提示词。
- 生成竖屏封面图、横屏封面图、分镜图、口播音频、字幕和竖屏视频。
...
- 最终新闻数：18 条。
- 请求轮次：5 轮。
- 新闻会按中国股票受众相关性重新排序，优先保留海外宏观、美元人民币、港股中概、AI 芯片、出口链和流动性相关内容。
